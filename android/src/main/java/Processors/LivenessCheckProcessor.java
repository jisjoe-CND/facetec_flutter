...
import com.facetec.facetec_flutter.FacetecFlutterPlugin;
...
public class LivenessCheckProcessor extends Processor implements FaceTecFaceScanProcessor {
    ...
    final private FacetecFlutterPlugin sampleAppActivity;

    public LivenessCheckProcessor(String sessionToken, Context context, FacetecFlutterPlugin plugin) {
